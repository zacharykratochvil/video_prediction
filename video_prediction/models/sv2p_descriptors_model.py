...
class SV2PDescriptorsVideoPredictionModel(VideoPredictionModel):
    """
    ...
    def __init__(self, *args, **kwargs):
        super(SV2PDescriptorsVideoPredictionModel, self).__init__(
            generator_fn, *args, ** kwargs)
        self.deterministic = not self.hparams.stochastic_model

    def get_default_hparams_dict(self):
        default_hparams = super(SV2PDescriptorsVideoPredictionModel, self).get_default_hparams_dict()
        hparams = dict(
            batch_size=32,
            l1_weight=0.0,
            l2_weight=1.0,
    ...
    def parse_hparams(self, hparams_dict, hparams):
        ...
        return super(SV2PDescriptorsVideoPredictionModel, self).parse_hparams(hparams_dict, hparams)
